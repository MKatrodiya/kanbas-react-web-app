  ...
  const comingUp = [
    {
      title: "Lecture",
      icon: <FaCalendar />,
      course: "CS4545.24342.202410",
      date: "Jan 12 at 11:45am",
    },
    {
      title: "CS5800 Lecture",
      icon: <FaCalendar />,
      course: "CS5800.24442.2024",
      date: "Jan 14 at 9:50am",
    },
    {
      title: "CS5010 Lecture",
      icon: <FaCalendar />,
      course: "CS5010.3467.202402",
      date: "Jan 12 at 11:45am",
    },
  ];
        ...
        {comingUp.map((item, index) => {
          return (
            <li className="list-group-item list-group-item-action">
              <Link to="#">
                {item.icon} &nbsp;{" "}
                <span className="font-red">{item.title}</span>
              </Link>
              <br />
              &emsp;
              <span className="text-black m-3">{item.course}</span>
              <br />
              &emsp;
