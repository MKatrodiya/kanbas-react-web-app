...
import { FaCheckCircle, FaChevronRight, FaEllipsisV, FaGripVertical, FaPlus, FaRegStickyNote } from "react-icons/fa";
                ...
                <li className="list-group-item">
                    <div>
                        ...
                        <span className="float-end">
                            <button className="wd-asmt-weightage me-2">
                                40% of Total
                            </button>
                            ...
                            return (
                                <li className="list-group-item">
                                    ...
                                    <Link
                                        ...
                                        style={{ fontSize: "1.25em" }}>{assignment.title}</Link>
                                    <span className="float-end">
