                ...
                <div className="col-12 mt-2" style={{ clear: "both" }}>
                    <div className="row">
                        <div className="col-6">
                            ...
                            ><b>Student Names</b></span>
                        </div>
                        <div className="col-6">
                            <span className="va-grade-input-header"
                            ><b>Assignment Names</b></span>
                        </div>
                        <div className="col-6">
                            <input
                ...
                <div className="table-responsive">
                    <table className="table table-striped table-bordered wd-grades-table">
                        <thead className="thead-light">
                            <th style={{ textAlign: "left", paddingLeft: "10px" }}>Student Name</th>
                        ...
                        <tbody>
                            {es.map((enrollment) => {
                                ...
                                return (
                                    <tr>
                                        <td className="wd-grades-name">{user?.firstName} {user?.lastName}</td>
                                        {as.map((assignment) => {
                                            const grade = grades.find(
                                                (grade) => grade.student === enrollment.user && grade.assignment === assignment._id);
                                            return (<td>{grade?.grade || `${Math.floor(Math.random() * (100 - 60 + 1) + 60)}`}</td>);
                                        })}
                                    </tr>);
                            })}
                        </tbody></table>
